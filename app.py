...
MM = pd.read_csv("MM_Dummies22.csv")
...
def callback(Reported_Year,Country, Region, COD, Migration_Route):
    ...
    try:
        ...
        return px.scatter_mapbox(
            ...
            color_discrete_sequence=['black', 'brown', 'darkgrey', 'darkgreen', 'maroon', 'red', 'navy', 'violet', 'darkolivegreen', 'darkkhaki', 'chocolate', 'mediumvioletred', 'chartreuse', 'dimgray', 'darkorchid', 'darksalmon', 'moccasin', ' saddlebrown', 'darkgoldenrod', 'darkslategrey', 'orangered']).update_layout({"plot_bgcolor":"rgba(0, 0, 0, 0)",
